...
**Synthetic markets** on pump.fun coins — binary questions published on ezpz, not the raw pump.fun coin feed. Makers and community members author markets; the platform factory also publishes trending mcap-threshold markets.

| Shape | Example |
|-------|---------|
| Graduation | Will this coin graduate by Friday? |
| Market-cap threshold | Will it cross $5m mcap by Friday? |
| 5-minute up/down | Will it be Up or Down at 18:35 UTC? |

Authors can optionally link their pump.fun creator wallet for a **Verified creator** badge. See [Pump.fun markets](/concepts/pumpfun-markets) and [For pump.fun creators & community](/guides/pumpfun-creators).
