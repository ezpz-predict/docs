...
|-------|--------------|-----------|
| **AMM** | Swap against a liquidity pool | **Live** — default for retail betting |
...
- Prices set by the pool curve (constant-product today, LS-LMSR upgrade planned)
