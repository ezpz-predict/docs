...
When you bet on ezpz.fi, you hold **outcome tokens** — SPL tokens on Solana representing YES or NO on a specific market.
...
<Tip>
  See [Resolution](/concepts/resolution) for the full settlement timeline including dispute windows.
</Tip>

## Parlay positions

Parlay bets are separate from single-market positions. They are backed by the parlay LP pool, not individual market vaults. See [Parlays](/concepts/parlays).
