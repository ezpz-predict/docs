...
Your tokens live in a **self-custodial wallet** managed by the platform. You see balances in **Portfolio** (`/portfolio`) without managing SPL token accounts yourself.
