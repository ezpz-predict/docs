---
title: "Parlays"
description: "Multi-leg accumulator bets on ezpz.fi."
icon: "layer-group"
---

## What is a parlay?

A **parlay** combines two or more legs into a single bet. **All legs must win** for you to receive a payout. If any leg loses, the entire parlay loses.
...
You cannot include two legs from the **same match** in one parlay. The platform enforces this on-chain to prevent correlated bets that would not be true independent outcomes.
...
Single-market bets and parlay bets use different funding sources. See [Outcome tokens](/concepts/outcome-tokens) for how single bets settle.
