...
| Property | Behavior |
|----------|----------|
| **Pricing** | LS-LMSR cost function; trades priced by $\Delta C$ |
...
| Higher $\alpha$ at creation | Deeper at every $T$, but more vig ($2\alpha\ln 2$ at even odds) |
...
|---------|-------------|-------|
| **Current price** | Clamped marginal $p_i$ or implied $\sigma$ | Orientation: buying YES raises YES price |
| **Trade preview** | Exact $\Delta C$ for your stake | Includes slippage + embedded vig |
