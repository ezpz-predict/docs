...
Every market, bet, and payout is recorded on Solana. You do not need to interact with the chain directly — but settlement is verifiable on-chain. See [Architecture & settlement](/concepts/architecture), [Outcome tokens](/concepts/outcome-tokens), and [Resolution](/concepts/resolution).
