...
description: "Create synthetic markets on pump.fun coins and games as the coin creator or as a community member."
icon: "user-pen"
---
...
- The market stays **Pending** until the platform captures the reference price at window open and then it opens for five minutes of trading.
...
<Steps>
  ...
  <Step title="Sign the message">
    Approve the canonical message in Phantom: `ezpz creator link: <coinMint> <userId> <nonce>`.
  </Step>
