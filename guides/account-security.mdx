...
ezpz.fi uses your **Solana wallet** (Phantom, Solflare, etc.) for authentication. Connecting your wallet creates or links a **custodial account** used for trading. EZPZ also uses privy if users choose to utilize this function.
