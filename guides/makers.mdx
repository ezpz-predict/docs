...
- Open games and seed pools
- Seed AMM liquidity so players can trade
- Earn maker fees on every prediction placed on your markets

Makers have a different dashboard compared to users. 

## Become a maker

<Steps>
  <Step title="Sign up as a maker">
     Referral from an existing Maker initially to **become a maker** from an existing account.
  </Step>
...
<Steps>
  ...
  <Step title="Publish">
    Submit the market. On-chain creation runs in the background and status updates appear in your authoring dashboard (`/authoring/[id]`).
  </Step>
</Steps>
