...
Redemption is executed on-chain via the `redeem` instruction. The platform submits the transaction through your custodial wallet and you do not need to sign each redemption manually.
