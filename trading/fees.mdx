...
## Three fees on single predictions
...
Makers who seed AMM liquidity earn the **0.3% swap fee** on every trade, win or lose. LP positions also settle at resolution like any other token holder while the losing side of the pool goes to zero.
